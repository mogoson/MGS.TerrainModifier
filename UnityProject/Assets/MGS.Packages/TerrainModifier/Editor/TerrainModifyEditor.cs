...
namespace MGS.TerrainModifier
{
    public class TerrainModifyEditor : ScriptableWizard
    {
        ...
        {
            DisplayWizard("Terrain Modifier", typeof(TerrainModifyEditor), "Modify");
        }
        ...
        private void OnWizardCreate()
        {
            ...
            if (modify)
            {
                RaiseTerrainHeight(terrainData, raiseHeight);
            }
        }

        private void RaiseTerrainHeight(TerrainData terrainData, float raiseHeight)
        {
